...
window.title("Diabetic Retinopathy Disease Detection System")
fn1=""
...
def bact():
    ...
    window1.title("Diabetic Retinopathy Disease Prediction System")
    ...
    window1.mainloop()
def bact1():
    rem1 = "The remedies for Bacterial Spot are:\n\n "
    messagebox.showinfo("probable remedies",rem1)
...
def latebl():
    ...
    window1.title("Diabetic Retinopathy Disease Prediction using CNN")
    ...
    button1.grid(column=0, row=10, padx=20, pady = 20)
...
def analysis():
    ...
    message = tk.Label(text='Status: ', background="lightgreen",
                           fg="Brown", font=("", 15))
    message.grid(column=0, row=3, padx=10, pady=10)
    disease = tk.Label(text=' ' , background="lightgreen",
                               fg="Black", font=("", 15))
    disease.grid(column=0, row=4, padx=10, pady=10)
    disease = tk.Label(text='Disease Name: ', background="lightgreen",
                               fg="Black", font=("", 15))
...
def openphoto():
    dirPath = "C:\\Users\\ADMIN\\Desktop\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data"
    global fn1
    fileList = os.listdir("C:\\Users\\ADMIN\\Desktop\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data")
    for fileName in fileList:
        os.remove("D:\\Users\\ADMIN\\Desktop\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data")
      
    fileName = askopenfilename(initialdir='D:\\Users\\ADMIN\\Desktop\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data', title='Select image for analysis ',
                           filetypes=[('image files', '.jpeg')])
    fn=fileName.split('/')
    fn1=fn[-1][:-5]
    print(fn1)
    d_type=label[label['image']==fn1]['level']
    print(d_type)
    dst = "D:\\Users\\ADMIN\\Desktop\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data"

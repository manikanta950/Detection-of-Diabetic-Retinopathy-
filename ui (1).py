...
def analysis():
    ...
    disease = tk.Label(text='Stage ', background="lightgreen",
                               fg="Black", font=("", 15))
    ...
    #message.grid(column=0, row=3, padx=10, pady=10)
    messagebox.showinfo("Disease stage",str_label)

def openphoto():
    dirPath = "D:\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data\\testpicture"
    global fn1
    fileList = os.listdir(dirPath)
    for fileName in fileList:
        os.remove("D:\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data\\testpicture\\" + fileName)
    ...
    fileName = askopenfilename(initialdir='D:\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data', title='Select image for analysis ',
    ...
    #print(d_type)
    dst = "D:\\Diabetic_Retinopathy_Detection-master\\Diabetic_Retinopathy_Detection-master\\data\\testpicture"
